  ...
  return (
    <section id="about" className="py-20 bg-gray-100 dark:bg-gray-900 text-center">
      ...
      <p className="text-lg mb-6 max-w-2xl mx-auto text-gray-700 dark:text-gray-300">
        My journey as a developer has been shaped by a passion for problem-solving and a love for technology. I believe that code can change lives by solving real-world challenges, and I’m constantly seeking new ways to improve my skills and expand my knowledge.
      </p>
